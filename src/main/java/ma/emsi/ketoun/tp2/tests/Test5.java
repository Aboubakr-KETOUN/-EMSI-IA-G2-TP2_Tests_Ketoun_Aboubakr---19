...
public class Test5 {
    ...
    public static void main(String[] args) {
        ...
        //ajout de splitter pour decouper le fichier
        ...
        String question = "Quel est l'objectif du cours 'Agents conversationnels en Java avec LangChain4j' de Richard Grin ? A quelle slide ca ce trouve???";
